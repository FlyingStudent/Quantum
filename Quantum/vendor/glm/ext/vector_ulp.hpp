...
namespace glm
{
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, T, Q> lastFloat(vec<L, T, Q> const& x);
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, T, Q> lastFloat(vec<L, T, Q> const& x, int ULPs);
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, T, Q> lastFloat(vec<L, T, Q> const& x, vec<L, int, Q> const& ULPs);
