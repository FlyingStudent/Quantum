...
namespace glm
{
	...
	/// @see ext_vector_integer
	template<length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, T, Q> lastPowerOfTwo(vec<L, T, Q> const& v);
	...
	/// @see ext_vector_integer
	template<length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, T, Q> lastMultiple(vec<L, T, Q> const& v, T Multiple);
	...
	/// @see ext_vector_integer
	template<length_t L, typename T, qualifier Q>
	GLM_FUNC_DECL vec<L, T, Q> lastMultiple(vec<L, T, Q> const& v, vec<L, T, Q> const& Multiple);
