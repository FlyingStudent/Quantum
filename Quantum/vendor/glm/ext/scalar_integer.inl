...
namespace detail
{
	...
	template<typename genIUType>
	GLM_FUNC_QUALIFIER genIUType lastPowerOfTwo(genIUType value)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genIUType>::is_integer, "'lastPowerOfTwo' only accept integer inputs");
	...
	template<typename genIUType>
	GLM_FUNC_QUALIFIER genIUType lastMultiple(genIUType Source, genIUType Multiple)
	{
		GLM_STATIC_ASSERT(std::numeric_limits<genIUType>::is_integer, "'lastMultiple' only accept integer inputs");
