...
namespace Quantum {
	...
	void Renderer2D::Init()
	{
		...
		//set texture at slot 0 = white texture
 ...
 void Renderer2D::FlushAndReset()
	...
	{
		DrawQuad({ position.x,position.y,0.0f }, { size.x,size.y }, texture, tilingFactor, tintColor);
	}
	void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const Ref<Texture2D>& texture, float tilingFactor, const glm::vec4& tintColor)
	{
		QT_PROFILE_FUNCTION();

		glm::mat4 transform = glm::translate(glm::mat4(1.0f), position) * /*Rotatoin*/glm::scale(glm::mat4(1.0f), { size.x,size.y,1.0f });
	...
	{
		DrawQuad({ position.x,position.y,0.0f }, { size.x,size.y }, subTexture, tilingFactor, tintColor);
	}
	...
	void Renderer2D::DrawRotatedQuad(const glm::vec3& position, const glm::vec2& size, float rotation, const glm::vec4& color)
	{
		...
		const float textureIndex = 0.0f; //white texture
		const float tilingFactor = 1.0f; //no tiling
